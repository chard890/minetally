...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "glass-panel text-slate-950 rounded-[26px] border border-white/45 shadow-[0_18px_40px_rgba(110,91,140,0.12)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-2xl font-bold leading-none tracking-tight text-[#2b2b2b]",
      className
    )}
    {...props}
  />
